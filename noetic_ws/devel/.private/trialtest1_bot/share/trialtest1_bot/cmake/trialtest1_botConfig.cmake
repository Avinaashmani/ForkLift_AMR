...
if("TRUE" STREQUAL "TRUE")
  ...
  set(trialtest1_bot_DEVEL_PREFIX /home/avinaash/noetic_ws/devel/.private/trialtest1_bot)
  ...
  set(trialtest1_bot_INSTALL_PREFIX /home/avinaash/noetic_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trialtest1_bot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/noetic_ws/src/trialtest1_bot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/noetic_ws/devel/.private/trialtest1_bot/lib;/home/avinaash/noetic_ws/devel/lib;/opt/ros/noetic/lib)
