...
static const _ForkLiftDock_Request_type_support_symbol_names_t _ForkLiftDock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, forklift_interfaces, srv, ForkLiftDock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, forklift_interfaces, srv, ForkLiftDock_Request)),
  }
};
...
static const _ForkLiftDock_Response_type_support_symbol_names_t _ForkLiftDock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, forklift_interfaces, srv, ForkLiftDock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, forklift_interfaces, srv, ForkLiftDock_Response)),
  }
};
...
static const _ForkLiftDock_type_support_symbol_names_t _ForkLiftDock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, forklift_interfaces, srv, ForkLiftDock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, forklift_interfaces, srv, ForkLiftDock)),
  }
};
