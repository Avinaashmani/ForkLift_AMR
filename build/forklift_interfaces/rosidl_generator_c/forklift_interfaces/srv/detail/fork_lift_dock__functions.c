...
{
  forklift_interfaces__srv__ForkLiftDock_Request * msg = (forklift_interfaces__srv__ForkLiftDock_Request *)malloc(sizeof(forklift_interfaces__srv__ForkLiftDock_Request));
  if (!msg) {
    return NULL;
  }
...
forklift_interfaces__srv__ForkLiftDock_Request__Sequence__init(forklift_interfaces__srv__ForkLiftDock_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (forklift_interfaces__srv__ForkLiftDock_Request *)calloc(size, sizeof(forklift_interfaces__srv__ForkLiftDock_Request));
    if (!data) {
      return false;
    }
...
{
  forklift_interfaces__srv__ForkLiftDock_Request__Sequence * array = (forklift_interfaces__srv__ForkLiftDock_Request__Sequence *)malloc(sizeof(forklift_interfaces__srv__ForkLiftDock_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  forklift_interfaces__srv__ForkLiftDock_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    forklift_interfaces__srv__ForkLiftDock_Request * data =
      (forklift_interfaces__srv__ForkLiftDock_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!forklift_interfaces__srv__ForkLiftDock_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          forklift_interfaces__srv__ForkLiftDock_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  forklift_interfaces__srv__ForkLiftDock_Response * msg = (forklift_interfaces__srv__ForkLiftDock_Response *)malloc(sizeof(forklift_interfaces__srv__ForkLiftDock_Response));
  if (!msg) {
    return NULL;
  }
...
forklift_interfaces__srv__ForkLiftDock_Response__Sequence__init(forklift_interfaces__srv__ForkLiftDock_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (forklift_interfaces__srv__ForkLiftDock_Response *)calloc(size, sizeof(forklift_interfaces__srv__ForkLiftDock_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  forklift_interfaces__srv__ForkLiftDock_Response__Sequence * array = (forklift_interfaces__srv__ForkLiftDock_Response__Sequence *)malloc(sizeof(forklift_interfaces__srv__ForkLiftDock_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  forklift_interfaces__srv__ForkLiftDock_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    forklift_interfaces__srv__ForkLiftDock_Response * data =
      (forklift_interfaces__srv__ForkLiftDock_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!forklift_interfaces__srv__ForkLiftDock_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          forklift_interfaces__srv__ForkLiftDock_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
