...
class Dockpallet(Node):
    ...
    def __init__(self):
        ...
        self.dock_with_load = False
        self.undock_with_load = False
        
        self.dock_no_load = False
        self.undock_no_load = False
    ...
    def dock(self):
        ...
        if self.dock_flag and self.navigate_flag and self.dock_no_load:
            self.diagnostics.data = "<< Docking without Pallet >>"
        ...
        elif self.dock_flag and self.navigate_flag and self.dock_with_load:
