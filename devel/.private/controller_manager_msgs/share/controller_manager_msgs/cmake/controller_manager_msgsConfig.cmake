...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /home/avinaash/ForkLift_AMR/src/ros_control/controller_manager_msgs)
  set(controller_manager_msgs_DEVEL_PREFIX /home/avinaash/ForkLift_AMR/devel/.private/controller_manager_msgs)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX /home/avinaash/ForkLift_AMR/install)
...
if(NOT "/home/avinaash/ForkLift_AMR/devel/.private/controller_manager_msgs/include " STREQUAL " ")
  set(controller_manager_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/avinaash/ForkLift_AMR/devel/.private/controller_manager_msgs/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/ForkLift_AMR/src/ros_control/controller_manager_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/ForkLift_AMR/devel/.private/controller_manager_msgs/lib;/home/avinaash/ForkLift_AMR/devel/lib;/opt/ros/noetic/lib)
