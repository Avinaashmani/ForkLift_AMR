...
if("TRUE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /home/avinaash/ForkLift_AMR/src/ros_controllers/velocity_controllers)
  set(velocity_controllers_DEVEL_PREFIX /home/avinaash/ForkLift_AMR/devel/.private/velocity_controllers)
  ...
  set(velocity_controllers_INSTALL_PREFIX /home/avinaash/ForkLift_AMR/install)
...
if(NOT "/home/avinaash/ForkLift_AMR/src/ros_controllers/velocity_controllers/include " STREQUAL " ")
  set(velocity_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/avinaash/ForkLift_AMR/src/ros_controllers/velocity_controllers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/ForkLift_AMR/src/ros_controllers/velocity_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/ForkLift_AMR/devel/.private/velocity_controllers/lib;/home/avinaash/ForkLift_AMR/devel/lib;/opt/ros/noetic/lib)
