...
if("TRUE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX /home/avinaash/ForkLift_AMR/src/ros_controllers/imu_sensor_controller)
  set(imu_sensor_controller_DEVEL_PREFIX /home/avinaash/ForkLift_AMR/devel/.private/imu_sensor_controller)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX /home/avinaash/ForkLift_AMR/install)
...
if(NOT "/home/avinaash/ForkLift_AMR/src/ros_controllers/imu_sensor_controller/include " STREQUAL " ")
  set(imu_sensor_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/avinaash/ForkLift_AMR/src/ros_controllers/imu_sensor_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/ForkLift_AMR/src/ros_controllers/imu_sensor_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/ForkLift_AMR/devel/.private/imu_sensor_controller/lib;/home/avinaash/ForkLift_AMR/devel/lib;/opt/ros/noetic/lib)
