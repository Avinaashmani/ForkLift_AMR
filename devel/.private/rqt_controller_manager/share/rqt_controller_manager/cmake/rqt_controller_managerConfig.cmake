...
if("TRUE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /home/avinaash/ForkLift_AMR/src/ros_control/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /home/avinaash/ForkLift_AMR/devel/.private/rqt_controller_manager)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /home/avinaash/ForkLift_AMR/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/ForkLift_AMR/src/ros_control/rqt_controller_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/ForkLift_AMR/devel/.private/rqt_controller_manager/lib;/home/avinaash/ForkLift_AMR/devel/lib;/opt/ros/noetic/lib)
