...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/avinaash/ForkLift_AMR/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/avinaash/ForkLift_AMR/devel/.private/diff_drive_controller)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/avinaash/ForkLift_AMR/install)
...
if(NOT "/home/avinaash/ForkLift_AMR/devel/.private/diff_drive_controller/include;/home/avinaash/ForkLift_AMR/src/ros_controllers/diff_drive_controller/include;/usr/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/avinaash/ForkLift_AMR/devel/.private/diff_drive_controller/include;/home/avinaash/ForkLift_AMR/src/ros_controllers/diff_drive_controller/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinaash/ForkLift_AMR/src/ros_controllers/diff_drive_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avinaash/ForkLift_AMR/devel/.private/diff_drive_controller/lib;/home/avinaash/ForkLift_AMR/devel/lib;/opt/ros/noetic/lib)
